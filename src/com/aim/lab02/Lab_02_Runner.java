...
import com.aim.lab01.DavissBitHC;
...
public class Lab_02_Runner extends TestFrame {
	...
	public Lab_02_Runner(Lab02TestFrameConfig config) {
	...
	public static void main(String[] args) {
		...
		Lab02TestFrameConfig config = Lab02TestFrameConfig.getInstance();
		TestFrame oTestFrame = new Lab_02_Runner(config);
		oTestFrame.runTests();
	}
}
