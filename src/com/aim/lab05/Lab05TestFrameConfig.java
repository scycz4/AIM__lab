...
public class Lab05TestFrameConfig extends TestFrameConfig {
	 ...
	 */
	private static final long m_parentSeed = 19032021l;

	private static Lab05TestFrameConfig oThis;

	private Lab05TestFrameConfig() {
		
		super(new long[] { m_parentSeed });
	}

	public synchronized static Lab05TestFrameConfig getInstance() {
		
		if (oThis == null) {
			oThis = new Lab05TestFrameConfig();
		}
